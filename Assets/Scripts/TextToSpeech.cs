...
public class TextToSpeech : MonoBehaviour
{
    ...
    {
        var credentials = new BasicAWSCredentials("AKIA3HJBCTUNQIOM2LGY", "6kAlNOoeFynVIfdkGROjaaTsxqLq6O0zBZiXF3sD");
        var client = new AmazonPollyClient(credentials, RegionEndpoint.APNortheast2);
